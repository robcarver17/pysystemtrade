...
my_config.instruments = ["ALUMINIUM", "SOFR", "CORN"]
...
print(my_system.combForecast.get_forecast_weights("ALUMINIUM").tail(5))
print(my_system.combForecast.get_forecast_diversification_multiplier("ALUMINIUM").tail(5))
