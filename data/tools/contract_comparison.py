...
class ContractComparison:
    ...
    def _create_comparison(self, instrument_code: str, price_date_str: str, forward_date_str: str):
        ...
        """
        price_contract = futuresContract(instrument_object=instrument_code, contract_date_object=price_date_str)
    ...
    def get_volume_comparison(self, instrument_code: str, price_date_str: str, forward_date_str: str,
        ...
        comparison_df = comparison_df.drop(columns=['OPEN_price', 'OPEN_forward', 'HIGH_price', 'HIGH_forward',
                                                    'LOW_price', 'LOW_forward', 'FINAL_price', 'FINAL_forward'])
    ...
    def get_price_comparison(self, instrument_code: str, price_date_str: str, forward_date_str: str,
        ...
        comparison_df = comparison_df.drop(columns=['OPEN_price', 'OPEN_forward', 'HIGH_price', 'HIGH_forward',
                                                    'LOW_price', 'LOW_forward', 'VOLUME_price', 'VOLUME_forward'])
    ...
    def get_price_volume_comparison(self, instrument_code: str, price_date_str: str, forward_date_str: str,
        ...
        price_comparison_df = self.get_price_comparison(instrument_code=instrument_code,
                                                        price_date_str=price_date_str,
                                                        forward_date_str=forward_date_str,
                                                        resample_period=resample_period)

        volume_comparison_df = self.get_volume_comparison(instrument_code=instrument_code,
                                                          price_date_str=price_date_str,
                                                          forward_date_str=forward_date_str,
                                                          resample_period=resample_period)

        merged_comparisons = pd.merge(price_comparison_df,
