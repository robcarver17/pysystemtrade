...
def get_filename_for_package(name_with_dots):
    ...
    ## join last two things together. This is probably the most obfuscated code I've ever written
...
def get_pathname_for_package_from_list(path_as_list):
    ...
    pathname = os.path.join(get_pathname_for_package_from_list(path_as_list),  last_item_in_list)
