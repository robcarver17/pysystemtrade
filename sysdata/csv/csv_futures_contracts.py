...
class csvFuturesContractData(futuresContractData):
    ...
    """
    def __init__(self, datapath = arg_not_supplied, log=logtoscreen("csvFuturesContractData")):
    ...
    def write_contract_list_as_df(self, instrument_code, contract_list):
        ...
        df = pd.DataFrame(dict(date = list_of_contract_date, sampling = list_of_sampling,
