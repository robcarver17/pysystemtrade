...
class seriesOfMargin(pd.Series):
    ...
    def add_value(self, value: float,
        ...
        return seriesOfMargin(self.append(pd.Series([value],
                                                    index=[dateref])))
...
class marginData(object):
    ...
    def add_total_margin_entry(self, margin_entry: float):
        self.add_strategy_margin_entry(margin_entry=margin_entry,
                                    strategy_name=TOTAL_MARGIN)
    ...
    def get_current_strategy_margin(self, strategy_name: str) -> float:
        series_of_margin = self.get_series_of_strategy_margin(strategy_name=strategy_name)
    ...
    def add_strategy_margin_entry(self, margin_entry: float,
        ...
        self._write_series_of_strategy_margin(strategy_name,
                                              series_of_margin=new_series)
    ...
    def _write_series_of_strategy_margin(self, strategy_name: str,
                                         series_of_margin: seriesOfMargin):
        raise NotImplementedError