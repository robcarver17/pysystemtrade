...
class controlProcessData(baseData):
    ...
    def get_dict_of_control_processes(self):
        ...
        output_dict = dict([(process_name, self._get_control_for_process_name(process_name)) \
    ...
    def _update_control_for_process_name(self, process_name, new_control_object):
        existing_control = self._get_control_for_process_name_without_default(process_name)
        if existing_control is missing_data:
            self._add_control_for_process_name(process_name, new_control_object)
        else:
            self._modify_existing_control_for_process_name(process_name, new_control_object)
    ...
    def _modify_existing_control_for_process_name(self, process_name, new_control_object):
        self._control_store[process_name] = new_control_object
