...
class parquetSpreadsForInstrumentData(spreadsForInstrumentData):
    ...
    def get_list_of_instruments(self) -> list:
        return self.parquet.get_all_identifiers_with_data_type(data_type=SPREAD_COLLECTION)

    def _get_spreads_without_checking(
        self, instrument_code: str
    ) -> spreadsForInstrument:
        data = self.parquet.read_data_given_data_type_and_identifier(data_type=SPREAD_COLLECTION, identifier=instrument_code)
    ...
    def _delete_spreads_without_any_warning_be_careful(self, instrument_code: str):
        self.parquet.delete_data_given_data_type_and_identifier(data_type=SPREAD_COLLECTION, identifier=instrument_code)
        self.log.debug(
    ...
    def _add_spreads_without_checking_for_existing_entry(
        ...
        self.parquet.write_data_given_data_type_and_identifier(data_type=SPREAD_COLLECTION, data_to_write=spreads_as_pd, identifier=instrument_code)
        self.log.debug(
