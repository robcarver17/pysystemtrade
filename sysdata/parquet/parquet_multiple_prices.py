...
class parquetFuturesMultiplePricesData(futuresMultiplePricesData):
    ...
    def __init__(
        self,parquet_access: ParquetAccess, log=get_logger("parquetFuturesMultiplePricesData")
    ):
    ...
    def get_list_of_instruments(self) -> list:
        return self.parquet.get_all_identifiers_with_data_type(data_type=MULTIPLE_COLLECTION)

    def _get_multiple_prices_without_checking(
        self, instrument_code: str
    ) -> futuresMultiplePrices:
        data = self.parquet.read_data_given_data_type_and_identifier(data_type=MULTIPLE_COLLECTION, identifier=instrument_code)
    ...
    def _delete_multiple_prices_without_any_warning_be_careful(
        ...
        self.parquet.delete_data_given_data_type_and_identifier(data_type=MULTIPLE_COLLECTION, identifier=instrument_code)
        self.log.debug(
    ...
    def _add_multiple_prices_without_checking_for_existing_entry(
        ...
        self.parquet.write_data_given_data_type_and_identifier(data_type=MULTIPLE_COLLECTION, identifier=instrument_code, data_to_write=multiple_price_data_aspd)
        self.log.debug(
