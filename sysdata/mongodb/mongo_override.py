...
class mongoOverrideData(overrideData):
    ...
    def __init__(self, mongo_db=None, log=logtoscreen("mongoOverrideData")):
        ...
        self._mongo = mongoConnection(OVERRIDE_STATUS_COLLECTION, mongo_db=mongo_db)
    ...
    def _get_override_value_for_key(self, dict_name, key):
        ...
        result_dict = self._mongo.collection.find_one(dict(dict_name=dict_name, key=key))
    ...
    def _update_override(self, dict_name, key, new_override_object):
        ...
        old_override_as_float = self._get_override_value_for_key(dict_name, key)
        ...
        if old_override_as_float is missing_data:
            ...
            if new_override_as_float==1.0:
                ...
                result = self._add_override_value(dict_name, key, new_override_as_float)
        else:
            ...
            if new_override_as_float==1.0:
                ...
                result = self._update_existing_override_value(dict_name, key, new_override_as_float)
    ...
    def _get_dict_of_items_with_overrides(self, dict_name):
        ...
        key_values = [(db_entry['key'], Override.from_float(db_entry['value'])) for db_entry in cursor]
