...
SR_by_system_bars = [
    SR_error_bars(curve.gross) for curve in [with_stop_loss, without_stop_loss]
]
SR_by_system_bars = pd.DataFrame(
    SR_by_system_bars,
    ["With stop loss", "Continous trading"],
...
joint_order = [[x, y]
               for x, y in zip(ordered_names[1:4], ordered_names_NS[1:4])]
