...
def calculate_adjustment_factor(speed_control: speedControlForDynamicOpt,
                                              tracking_error_of_prior: float) -> np.array:
...
def adjust_weights_with_factor(optimised_weights_as_np: np.array,
...
def calculate_adjusting_trades_rounding_in_contract_space(adjusted_trades_weight_space: np.array,
                               per_contract_value_as_np: np.array
                                                          )-> np.array:

    adjusted_trades_in_contracts = adjusted_trades_weight_space / per_contract_value_as_np
    rounded_adjusted_trades_in_contracts = np.round(adjusted_trades_in_contracts)
    rounded_adjusted_trades_as_weights = rounded_adjusted_trades_in_contracts * per_contract_value_as_np
