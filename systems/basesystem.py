...
class System(object):
    ...
    def get_items_for_instrument(self, instrument_code):
        ...
        items_code_list=[self.get_instrument_codes_for_item(itemname) for itemname in items_with_data]
        items_with_instrument_data=[itemname for (itemname, code_list) in zip(items_with_data, items_code_list) if instrument_code in code_list]
    ...
    def delete_items_for_instrument(self, instrument_code, delete_protected=False):
        ...
        if not delete_protected:
            ...
            item_list=[itemname for itemname in item_list if itemname not in protected_items]
            
        deleted_values=[self._delete_item_from_cache(itemname, instrument_code) for itemname in item_list]
    ...
    def delete_items_across_system(self, delete_protected=False):
        return self.delete_items_for_instrument(ALL_KEYNAME, delete_protected=delete_protected)
    ...
    def get_item_from_cache(self, itemname, instrument_code=ALL_KEYNAME, keyname=None):
        """
    ...
    def _delete_item_from_cache(self, itemname, instrument_code=ALL_KEYNAME, keyname=None):
    ...
    def set_item_in_cache(self, value, itemname, instrument_code=ALL_KEYNAME, keyname=None):
        """
