...
class Test(unittest.TestCase):
    ...
    def test_get_scaled_forecast(self):
        ...
        self.assertAlmostEqual(self.system.forecastScaleCap.get_scaled_forecast("EDOLLAR", "ewmac8").tail(1).values[0],  0.871230635)
    ...
    def test_get_capped_forecast(self):
        ...
        # fixed, normal cap
        self.assertAlmostEqual(self.system.forecastScaleCap.get_capped_forecast("EDOLLAR", "ewmac8").tail(1).values[0],  0.871230635)
        ...
        system3=System([self.rawdata, self.rules, self.forecast_scale_cap()], self.data, config)
        self.assertAlmostEqual(system3.forecastScaleCap.get_capped_forecast("EDOLLAR", "ewmac8").tail(1).values[0],  0.2)
