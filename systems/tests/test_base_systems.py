...
class Test(unittest.TestCase):
    ...
    def testName(self):
        ...
        def anestedfunction(system, instrument_code, keyname, wibble, another_wibble=10):
        ...
        ans=system.calc_or_cache_nested("c", "SP500", "thing", anestedfunction, "k")
        print(system._cache)

        ans=system.calc_or_cache("b", ALL_KEYNAME, afunction, "e", 120.0)
        print(system._cache)
        
        ans=system.calc_or_cache("protected", ALL_KEYNAME, afunction, "e", 120.0)
