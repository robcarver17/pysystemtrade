...
class Account(SystemStage):
    ...
    def get_subsystem_position(self, instrument_code):
        ...
        def instrument(self, subset=None, percentage=True,
                       isolated=False, sumup=False):
            pass

        def rules(self, subset=None, percentage=True,
                  isolated=False, sumup=False):
            pass

        def rulegroup(self, subset=None, percentage=True,
                      isolated=False, sumup=False):
            pass

        def rulestyle(self, subset=None, percentage=True,
                      isolated=False, sumup=False):
            pass

        # these should be in a futures accounting object...
        def assetclass(self, subset=None, percentage=True,
                       isolated=False, sumup=False):
            pass

        def country(self, subset=None, percentage=True,
                    isolated=False, sumup=False):
            pass
