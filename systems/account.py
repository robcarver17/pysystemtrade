...
class account(SystemStage):
    ...
    def get_notional_position(self, instrument_code):
        ...
        likely intermediate functions
         - get capital used by an instrument / rule pair
         - check if a string is an instrument/rule or group name
         - 
         
        subsets: str, list or tuple of lists. The first item in a list identifies that 'kind' of thing it is
                 we exclude anything from a category not included in the list
        """
