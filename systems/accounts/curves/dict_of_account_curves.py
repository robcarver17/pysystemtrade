...
from systems.accounts.pandl_calculators.pandl_calculation_dict import dictOfPandlCalculatorsWithGenericCosts, pandlCalculationWithoutPositions
...
class dictOfAccountCurves(dict):
    ...
    def summed_pandl_calculator(self,
                                capital
    ...
    def weighted(self) -> bool:
        ...
        if all(~weighted_list):
            return False
        raise Exception("Can't have a dict of account curves where some are weighted and some are unweighted")
