...
def _from_freq_str_to_frequency(freq_str):
    LOOKUP_DICT = dict(daily = Frequency.BDay,
...
def _from_curve_str_to_curve_type(curve_type_str):
    LOOKUP_DICT = dict(gross = GROSS_CURVE,
                       net = NET_CURVE,
                       costs = COSTS_CURVE)
...
class statsDict(dict):
    ...
    def dict_of_results_by_asset_name_equal_weighted(self, item: str = arg_not_supplied,
        ...
        unweighted_results = self.dict_of_results_by_asset_name(item=item,
                                                                account_curve_group=account_curve_group,
                                                                freq_str=freq_str,
        ...
        weighted_results = dict([(
            asset_name,
            weight * unweighted_results[asset_name]
                                  )
    ...
    def dict_of_results_by_asset_name_timeweighted(self, item: str = arg_not_supplied,
                                      account_curve_group: 'accountCurveGroup' = arg_not_supplied,
                               freq_str: str = "daily",
                               curve_type_str = "net",
                               is_percentage = True
    ...
    def dict_of_results_by_asset_name(self, item: str = arg_not_supplied,
                                      account_curve_group: 'accountCurveGroup' = arg_not_supplied,
                               freq_str: str = "daily",
                               curve_type_str = "net",
                               is_percentage = True
    ...
    def statresult_for_item(self,  asset_name: str,
        ...
        account_curve = self.account_curve_for_asset(account_curve_group = account_curve_group,
                                                    asset_name = asset_name,
                                                    freq_str=freq_str,
                                                    curve_type_str=curve_type_str,
                                                    is_percentage=is_percentage)
    ...
    def account_curve_for_asset(self,
                                asset_name: str,
                                account_curve_group: 'accountCurveGroup' = arg_not_supplied,
                               freq_str: str = "daily",
                               curve_type_str = "net",
        ...
        account_curve = accountCurve(account_curve_group.get_pandl_calculator_for_item(asset_name),
    ...
    def _time_weights(self) -> dict:
            ...
            [
                (asset_name,
                 self.account_curve_for_asset(
                                              asset_name=asset_name).length_in_months)
        ...
        dict_of_time_weights = dict([(asset_name,
                                      dict_of_time_lengths[asset_name] / average_length)
