...
from systems.accounts.pandl_calculators.pandl_generic_costs import  NET_CURVE, GROSS_CURVE, COSTS_CURVE


class nestedAccountCurveGroup(accountCurveGroup):
    def __init__(self, nested_dict_of_account_curves: nestedDictOfAccountCurves,
                 capital,
                    **kwargs):

        super().__init__(nested_dict_of_account_curves,
                         capital= capital,
                         **kwargs)
    ...
    def gross(self):
        ...
        return nestedAccountCurveGroup(self.nested_account_curves,
