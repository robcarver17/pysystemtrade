...
class _ForecastCombinePreCalculate(SystemStage):
    ...
    def get_forecasts_given_rule_list(
            self, instrument_code, rule_variation_list):
        """
    ...
    def get_trading_rule_list(self, instrument_code):
        ...
        if self._use_estimated_weights():
            ...
            # rule, but not here
            trial_rule_list = self.get_trading_rule_list_estimated_weights(
                instrument_code
            )
        else:
            trial_rule_list = self._get_trading_rule_list_fixed_weights(
                instrument_code)
...
class ForecastCombine(
    _ForecastCombineCalculateWeights, _ForecastCombineCalculateDivMult
):
    """
    ...
    def get_combined_forecast(self, instrument_code):
        ...
        raw_multiplied_combined_forecast = self._get_raw_combined_forecast(
            instrument_code
        )
