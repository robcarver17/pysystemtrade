...
def transfer_positions_between_strategies(old_strategy: str,
                                          new_strategy: str,
                                          instruments_to_transfer = arg_not_supplied):
    ...
    ___ = [transfer_position_instrument(data,
...
def get_old_strategy_positions(data: dataBlob, old_strategy: str):
    ...
    old_positions = diag_positions.get_dict_of_actual_positions_for_strategy(old_strategy)

    return old_positions

def transfer_position_instrument(data,
                                 old_strategy: str,
                                 new_strategy: str,
                                 instrument_code: str,
                                 old_positions: dict,
    ...
    balance_trade(data, strategy_name=old_strategy, instrument_code=instrument_code,
                  filled_price = filled_price,
                  fill_qty= - current_position
                  )

    balance_trade(data, strategy_name=new_strategy, instrument_code=instrument_code,
                  filled_price = filled_price,
                  fill_qty= current_position
                  )


def get_last_price(data: dataBlob,
                   instrument_code: str):
