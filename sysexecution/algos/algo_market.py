...
from sysexecution.algos.common_functions import post_trade_processing, MESSAGING_FREQUENCY, cancel_order, file_log_report_market_order
...
def manage_trade(data, broker_order_with_controls):
    ...
    trade_open = True
    log.msg("Managing trade %s with market order" % str(broker_order_with_controls.order))
    while trade_open:
        ...
        order_timeout =broker_order_with_controls.seconds_since_submission() > ORDER_TIME_OUT
