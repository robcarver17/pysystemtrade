...
class stackHandlerForRolls(stackHandlerCore):
    ...
    def check_roll_required(self, instrument_code):
        order_already_on_stack = self.check_if_roll_order_already_on_stack(instrument_code)
    ...
    def check_if_roll_order_already_on_stack(self, instrument_code):
        result = self.instrument_stack.does_strategy_and_instrument_already_have_order_on_stack(ROLL_PSEUDO_STRATEGY, instrument_code)
