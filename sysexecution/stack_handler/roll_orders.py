...
class stackHandlerForRolls(stackHandlerCore):
    ...
    def generate_force_roll_orders_for_instrument(self, instrument_code: str):
        ...
        if list_of_contract_orders is missing_order or instrument_order is missing_order:
            # No orders
            return None
...
def create_force_roll_orders(data: dataBlob, instrument_code: str) -> (instrumentOrder, listOfOrders):
    ...
    instrument_order = create_instrument_roll_order(roll_spread_info=roll_spread_info,
                                                    instrument_code=instrument_code)

    list_of_contract_orders = create_contract_roll_orders(data = data,
...
class rollSpreadInformation():
    ...
    def reference_price_spread(self) -> float:
        return self.reference_price_priced_contract - self.reference_price_forward_contract
...
def create_contract_orders_outright(roll_spread_info: rollSpreadInformation) -> listOfOrders:
