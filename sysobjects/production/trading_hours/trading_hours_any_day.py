...
class tradingHoursAnyDay():
    ...
    def intersect_with_list(self, list_of_open_times: 'listOfTradingHoursAnyDay') -> 'listOfTradingHoursAnyDay':
        intersected_list = []
...
class listOfTradingHoursAnyDay(list):
    ...
    def intersect(self, list_of_times: 'listOfTradingHoursAnyDay') -> 'listOfTradingHoursAnyDay':
        intersected_list = []
    ...
    def from_simple_list(cls, simple_list: list):
        ...
        list_of_times = [
            tradingHoursAnyDay.from_simple_list(
                opening_times
            )
