...
from sysobjects.production.trading_hours.trading_hours_any_day import listOfTradingHoursAnyDay
...
class weekdayDictOfListOfTradingHoursAnyDay(dict):
    ...
    def intersect(self, weekday_dict_of_list_of_open_times: 'weekdayDictOfListOfTradingHoursAnyDay') \
    ...
    @classmethod
    def from_simple_dict(cls, simple_dict: dict) -> 'weekdayDictOfListOfTradingHoursAnyDay':
...
def weekday_dict_of_trading_hour_from_simple_dict(simple_dict: dict) -> weekdayDictOfListOfTradingHoursAnyDay:
    weekday_dict = dict(
            [
                (
                    weekday_name,
...
def weekday_dict_of_trading_hours_from_simple_list(simple_list: list) -> weekdayDictOfListOfTradingHoursAnyDay:
    weekday_dict = dict(
            [
                (
                    weekday_name,
