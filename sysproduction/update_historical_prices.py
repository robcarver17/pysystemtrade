...
def get_and_add_prices_for_frequency(data, log, contract_object, frequency="D"):
    ...
    try:
        ib_prices = broker_data_source.get_prices_at_frequency_for_contract_object(contract_object, frequency)
        rows_added = db_futures_prices.update_prices_for_contract(contract_object, ib_prices,
