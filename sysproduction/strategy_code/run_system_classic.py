...
def updated_buffered_positions(data, strategy_name, system):
    ...
    for instrument_code in list_of_instruments:
        try:
            ...
            log.critical("Couldn't get or update buffered positions error %s" % e, instrument_code=instrument_code)
...
def construct_position_entry(data, system, instrument_code, lower_buffer, upper_buffer):
