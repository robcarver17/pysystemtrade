...
class diagLogs(productionDataLayerGeneric):
    ...
    def get_log_items(self, attribute_dict: dict=arg_not_supplied, lookback_days: int=1) -> list:
        """
    ...
    def print_log_items(self, attribute_dict: dict=arg_not_supplied, lookback_days: int=1):
        """
    ...
    def find_last_entry_date(self, attribute_dict=arg_not_supplied, lookback_days=30) -> datetime.datetime:
        if attribute_dict is arg_not_supplied:
            attribute_dict = {}
    ...
    def get_unique_list_of_values_for_log_attribute(
        ...
        unique_list_of_values = self.db_log_data.get_unique_list_of_values_for_log_attribute(
    ...
    def get_list_of_unique_log_attribute_keys(
        ...
        unique_list_of_log_attribute_keys = self.db_log_data.get_list_of_unique_log_attribute_keys(
            attribute_dict=attribute_dict, lookback_days=lookback_days
        )
