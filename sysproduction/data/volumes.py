...
class diagVolumes(object):
    ...
    def get_normalised_smoothed_volumes_of_contract_list(self, instrument_code,  contract_list, span=3):
        """
    ...
    def get_smoothed_volumes_of_contract_list(self, instrument_code, contract_list, span=3):
        """
        ...
        smoothed_volumes = [self.get_smoothed_volume_for_contract(instrument_code, contract_id, span=span)
                            for contract_id in contract_list]

        return  smoothed_volumes

    def get_smoothed_volume_for_contract(self, instrument_code, contract_id, span=3):
